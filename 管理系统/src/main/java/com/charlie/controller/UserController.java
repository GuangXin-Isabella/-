...
public class UserController extends GenericController {
  ...
  @ResponseBody
  public List getUsers2(@RequestParam Integer userId, HttpServletRequest request,
  ...
  public void getUsers3(@RequestParam Integer userId, HttpServletRequest request,
                        HttpServletResponse response) {
    //调用service方法得到用户列表
    //List<User> users = userService.getUsers(userId);
    logger.info("===============================成功查询用户列表！");
